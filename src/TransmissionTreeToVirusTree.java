    ...
    public static void main(String[] args){
        ...
        Arguments arguments = new Arguments(
                new Arguments.Option[]{
                        ...
                        new Arguments.RealOption(T50,"The time point at which the population is equal to half its" +
                                " final asymptotic value, in the logistic model), default = 0")
                });
